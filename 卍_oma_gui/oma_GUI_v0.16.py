...
class OmaApp:
    ...
    def hierarchical_clustering(self, params, ssidat):
        ...
        min_distances, threshold, Z, clusters = self.single_linkage_on_poles_list(params, valid_poles_list)
    ...
    def single_linkage_on_poles_list(self, params, poles_list):
        ...
        if clustering_method == 'min_distance':
            ...
            mean = np.mean(condensed_dist)
            std  = np.std(condensed_dist)
