...
class OmaApp:
    ...
    def construct_widgets(self):
        ...
        self.var_to_plot_mode_shape = tk.StringVar()
        ...
        self.param_rdb1_1_0 = tk.Radiobutton(self.param_lfm1_1, text='mpl (2D)'    , value='mpl'    , var=self.var_to_plot_mode_shape)
        self.param_rdb1_1_1 = tk.Radiobutton(self.param_lfm1_1, text='pyvista (3D)', value='pyvista', var=self.var_to_plot_mode_shape)
        ...
        self.param_rdb1_1_0.pack()
        self.param_rdb1_1_1.pack()
    ...
    def initialize_widgets_of_params(self):
        ...
        self.var_to_plot_mode_shape.set('mpl')
    ...
    def get_parameters(self):
        ...
        # get parameters
        """        param_dict = {
            'import' : {'data' : None, 'geo' : None},
            'set_up' : {'basic' : None, 'detrend_filter_decimate' : None},
            'mpe'    : {'basic' : None, 'visualize' : None},
            'FDD'    : {'basic' : None, },
            'SSI'    : {'basic' : None, 'h_clustering' : None, 'find_op_br' : None}
            }
        
        param_dict['import']['data'] = {
        ...
        param_dict['import']['geo'] ={
            'geo_path'              : self.geo_etr0_0_1.get(),
        } 

        param_dict['set_up']['basic'] ={
            'geo_path'              : self.geo_etr0_0_1.get(),
        } 

        param_dict['set_up']['detrend_filter_decimate'] ={
            'geo_path'              : self.geo_etr0_0_1.get(),
        } 
        ...
        param_dict = {
                    ...
                    'backend_of_mode_shape' : self.var_to_plot_mode_shape.get(),
    ...
    def _mpe_from_fdd_ssi(self, params, ss, efdd, ssidat):
        ...
        #====================================================================================================================
        min_distances, d_percent, Z, clusters = self.ssidat_single_linkage_method(ssidat.result, p['percentile'])
        ...
        # create dataframe of result of clustering analysis
        ...
        # output mode shape =========================================================
        self.save_mode_shape(ss, p['geo_path'], mode_nr, ssidat.result, ssi_save_folder, p['backend_of_mode_shape'])
        ...
        # output dataframe
        outnm_cluster_phi_FR = ("validation_"+os.path.splitext(os.path.basename(p['data_folder']))[0]+".csv")
    ...
    def hcluster_to_df(self, ssidat_result, percentile, min_cluster_elements):
        _, _, _, clusters = self.ssidat_single_linkage_method(ssidat_result, percentile)
        poles_list = self.extract_valid_poles(ssidat_result)
    ...
    def save_mode_shape(self, ss, geo, mode_nr, ssidat_result, save_folder, backend):
        if geo == '':
            return
