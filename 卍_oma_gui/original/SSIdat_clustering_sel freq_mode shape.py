...
folder_path =r'D:\Master\01_Project\02_Bell Tower\MEMS\2025.03.06\csv\2000s_bell'
file_names = [
    'acc1_all_155945_2000s - Copy.csv',
    'acc2_all_155945_2000s - Copy.csv',
    'acc3_all_155945_2000s - Copy.csv',
    'acc4_all_155945_2000s - Copy.csv',
    'acc5_all_155945_2000s - Copy.csv',
    'acc6_all_155945_2000s - Copy.csv',
    'acc8_all_155945_2000s - Copy.csv',
]
usecols = [0,1]
start_time = None

# import geometry file from csv file path
geo = r"d:\Master\01_Project\02_Bell Tower\geometry\BT_all_1.2.3.4.5.6.8.xlsx"

# save the file
folder = r"D:\Master\01_Project\06_data analysis\sample\automated 2000s bell auto (deci 5)"
...
fs = 200
freqlim = (0,15) # display frequency range
# setup SSIdat, SSIcov, p=LSCF parameter
br = 70 # br: Number of block datas in the Hankel matrix
ordmax = 80 # ordmax: Maximum model order for the analysis
...
q = 5 # the decimation factor (if 0, not decimation)
